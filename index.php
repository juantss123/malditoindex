...
<?php endif; ?>
  ...
  <section id="pricing" class="section-py" data-aos="slide-left" data-aos-duration="1400" data-aos-offset="200">
    <div class="container">
      ...
      <div class="row g-4 align-items-stretch">
        ...
        <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-duration="1200" data-aos-delay="700">
        ...
        <div class="col-md-6 col-lg-4" data-aos="slide-left" data-aos-duration="1100" data-aos-delay="900">
          <div class="price-card glass-card h-100">
            ...
            <div class="display-6 fw-bold text-white mb-3">A medida</div>
            <ul class="list-unstyled mb-4">
  ...
  <!-- Brands Carousel -->
  <section class="py-4 border-top border-ink-subtle" data-aos="fade-up" data-aos-duration="1000" data-aos-offset="100">
    <div class="container">
      <div class="text-center mb-4" data-aos="zoom-in" data-aos-duration="800" data-aos-delay="200">
        <h4 class="text-white mb-2">Confían en DentexaPro</h4>
        <p class="text-light opacity-75 mb-0">Clínicas y consultorios que ya usan nuestra plataforma</p>
      </div>
      
      <div class="brands-carousel-container" data-aos="slide-up" data-aos-duration="1000" data-aos-delay="400">
        <div class="brands-carousel">
          <div class="brand-item">
            <img src="https://via.placeholder.com/140x70/2F96EE/FFFFFF?text=Dental+Pro" alt="Clínica Dental Pro" class="brand-logo">
          </div>
          <div class="brand-item">
            <img src="https://via.placeholder.com/140x70/68C4FF/FFFFFF?text=Ortodental" alt="Ortodental Center" class="brand-logo">
          </div>
          <div class="brand-item">
            <img src="https://via.placeholder.com/140x70/9AD8FF/000000?text=Smile+Clinic" alt="Smile Clinic" class="brand-logo">
          </div>
          <div class="brand-item">
            <img src="https://via.placeholder.com/140x70/0A1B2B/FFFFFF?text=Excellence" alt="Dental Excellence" class="brand-logo">
          </div>
          <div class="brand-item">
            <img src="https://via.placeholder.com/140x70/122537/FFFFFF?text=Odonto+Plus" alt="Odonto Plus" class="brand-logo">
          </div>
          <div class="brand-item">
            <img src="https://via.placeholder.com/140x70/F5F9FF/2F96EE?text=Centro+Dental" alt="Centro Dental" class="brand-logo">
          </div>
          <div class="brand-item">
            <img src="https://via.placeholder.com/140x70/E6F2FF/2F96EE?text=Implant+Clinic" alt="Implant Clinic" class="brand-logo">
          </div>
          <div class="brand-item">
            <img src="https://via.placeholder.com/140x70/2387DC/FFFFFF?text=Dental+Care" alt="Dental Care" class="brand-logo">
          </div>
          <!-- Duplicar logos para loop continuo -->
          <div class="brand-item">
            <img src="https://via.placeholder.com/140x70/2F96EE/FFFFFF?text=Dental+Pro" alt="Clínica Dental Pro" class="brand-logo">
          </div>
          <div class="brand-item">
